...
func (q *Queries) GetOrderByCustomerId(ctx context.Context, customerID uuid.UUID) ([]Order, error) {
...
func (q *Queries) GetOrderByProductId(ctx context.Context, productID uuid.UUID) ([]Order, error) {
